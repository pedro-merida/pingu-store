...
const ProductModal = ({ isOpen, onClose, product }: ModalProps) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm p-4 transition-opacity duration-200
        ${isOpen ? 'opacity-100' : 'opacity-0'} bg-black/70`}
      onClick={onClose}
    >
      {/* Modal */}
      <div
